(function() {
    ...
    const maps = {
        ukr: {
            ...
            "1тим": "1 до Послання до Тимофія", "1тимофію": "1 до Тимофія", "1 тимофію": "1 до Тимофія", "1 тим": "1 до Тимофія",
        ...
        ru: {
            ...
            "мф": "Матфея", "matf": "Матфея", "матфея": "Матфея", "мат": "Матфея",
            "мк": "Марка", "марк": "Марка", "марка": "Марка", "мр": "Марка",
            "лк": "Луки", "лук": "Луки", "луки": "Луки",
            "ин": "Иоанна", "иоан": "Иоанна", "иоанна": "Иоанна",
            ...
            "иуд": "Иуды", "иуды": "Иуды",
            "rim": "Римлянам", "римлянам": "Римлянам",
    ...
    /** Відображає результат прямого пошуку за посиланням (глава/вірш) **/
    ...
    /** Додає окремий вірш до фрагмента документа для подальшого виводу **/
    ...
    /** Виконує пошук: розпізнає посилання або шукає за ключовими словами **/
    ...
    /** Завантажує JSON файл із текстом Біблії для обраної мови **/
    ...
    /** Обробка зміни мови інтерфейсу та пошуку **/
    if (langToggle) {
        langToggle.onclick = () => {
    ...
    /** Налаштування розміру шрифту та його збереження **/
    ...
    /** Обробник натискання клавіші Enter для швидкого переходу до тексту **/
    if (searchInput) {
